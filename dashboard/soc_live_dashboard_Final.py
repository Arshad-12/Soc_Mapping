...
app.layout = dbc.Container([
    ...
    dbc.Row([
        dbc.Col([
            html.Div([
                ...
                html.Span("Validated against ",
                          style={'color':'#aaa','fontSize':'11px'}),
                html.Span("Official MITRE ATT&CK",
                          style={'color':'#4fc3f7','fontSize':'11px',
                                 'fontWeight':'bold'}),
                html.Span("  |  ",
                          style={'color':'#444','fontSize':'11px'}),
                html.Span("Top-1: 70.0%",
                          style={'color':'#81c784','fontSize':'11px',
                                 'fontWeight':'bold'}),
                html.Span("  |  ",
                          style={'color':'#444','fontSize':'11px'}),
                html.Span("Top-3: 84.6%",
                          style={'color':'#81c784','fontSize':'11px',
                                 'fontWeight':'bold'}),
                html.Span("  |  ",
                          style={'color':'#444','fontSize':'11px'}),
                html.Span("Model: all-MiniLM-L12-v2",
                          style={'color':'#aaa','fontSize':'11px'}),
                html.Span("  |  ",
                          style={'color':'#444','fontSize':'11px'}),
                html.Span("Techniques: 691  |  Baselines: 3  |  ",
                          style={'color':'#aaa','fontSize':'11px'}),
                html.A("attack.mitre.org",
    ...
    # ── JS for Firefox-compatible file upload ─────────────
    html.Script('''
